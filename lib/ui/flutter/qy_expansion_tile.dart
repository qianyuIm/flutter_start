...
/// [QYExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
/// 去除分割线颜色
class QYExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const QYExpansionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  _QYExpansionTileState createState() => _QYExpansionTileState();
}

class _QYExpansionTileState extends State<QYExpansionTile> with SingleTickerProviderStateMixin {
